...
`lstinputlisting` files. We therefore render the hybrid-logic operators to readable
ASCII and drop anything still non-ASCII to `?` rather than break the build.
"""
